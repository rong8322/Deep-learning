# pylint: disable-msg=C0103,C0301,C0111,W0212
"""""""""""""""""""""""
Date:2017/09/15
Editor:Tu
...
class Network():
    def __init__(self, train_batch_size, test_batch_size, pooling_scale,
                 ...
                 optimizeMethod='adam', save_path='D:/Python/CNN/Models/default.ckpt'):
        """""
        @num_hidden: 隐藏层的节点数量
        @batch_size：因为我们要节省内存，所以分批处理数据。每一批的数据量。
		@optimizeMethod:優化演算法,預設Adam
        """""
    ...
    def retrain(self, train_samples, train_labels, *, data_iterator, iteration_steps):
    ...
    def print_confusion_matrix(self, confusionMatrix):
        ...
        for i, line in enumerate(confusionMatrix):
            print(i,'的正確率:' , line[i] / np.sum(line))
            # print(i,str(line) , line[i] / np.sum(line))
        # a = 0
