# pylint: disable-msg=C0103,C0301,W0212
"""""""""""""""""""""""
Date:2017/09/15
Editor:Tu
Description:CNN執行主程式
"""""""""""""""""""""""
...
if __name__ == '__main__':
    ...
    net = Network(
        ...
        dropout_rate=0.5,
        base_learning_rate=0.001, decay_rate=0.99, save_path='D:/Python/CNN/Models/v1.1.ckpt')# default
    net.define_inputs(
    ...
    # net.train(train_samples, train_labels, data_iterator=train_data_iterator, iteration_steps=20000)
    # net.retrain(train_samples, train_labels, data_iterator=train_data_iterator, iteration_steps=50)
    net.test(test_samples, test_labels, data_iterator=test_data_iterator)

    timer_end = timeit.default_timer()
    print("Time:%f"%(timer_end - timer_start))
else:
