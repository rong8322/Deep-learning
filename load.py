# encoding:utf-8
# pylint: disable-msg=C0103,C0301,C0111,W0212,w0612
# Python2 兼容
"""""""""""""""""""""
Date:2017/09/15
Editor:Tu
...
def distribution(labels, name):
    ...
    x = []
    y = []
    ls = OrderedDict(sorted(count.items()))
    for i, (k, v) in enumerate(ls.items()):
        # print(k, v)
        x.append(k)
        y.append(v)
...
# train = load('D:/Python/CNN/Database/Mat/MNIST_Train.mat')
test = load('D:/Python/CNN/Database/Mat/MNIST_Test.mat')
train = load('D:/Python/CNN/Database/Mat/train_1509.mat')
# test = load('D:/Python/CNN/Database/Mat/test_294.mat')
