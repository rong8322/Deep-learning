...
graph_path = 'D:\Python\CNN\Models\MNIST_4Conv_32x32.ckpt.meta'
weights_path = 'D:\Python\CNN\Models\MNIST_4Conv_32x32.ckpt'
...
if __name__ == '__main__':
    ...
    for i in range(0,54):
        im = cv.imread('D:\\Python\\CNN\\MNIST\\testimage\\number\\' +str(i) + ".jpg", cv.IMREAD_COLOR)
